...
import { useFetchCustomerFeedbacks } from "@/hooks/useCustomerFeedbacks"
      ...
      return (
         <section className="py-20 bg-background">
            <div className="container mx-auto px-6 text-center">
               <p className="text-destructive">Error loading testimonials: {error.message}</p>
            </div>
         </section>
      )
   }
         ...
         <section className="py-20 bg-background">
            <div className="container mx-auto px-6 text-center">
               <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                  <span className="bg-gradient-secondary bg-clip-text text-transparent">Client Testimonials</span>
               </h2>
               <p className="text-xl text-muted-foreground">No testimonials available</p>
            </div>
         </section>
      )
   }
      ...
      <section ref={ref} className="py-20 bg-background">
         <div className="container mx-auto px-6">
            ...
            >
               ...
               <p className="text-xl text-muted-foreground max-w-2xl mx-auto">(click on the cards to read)</p>
            </div>
                           ...
                           <div className="pt-4 border-t border-primary/10">
                              ...
                              {feedback.role ? (
                                 <p className="text-base  text-blue-600">
                                    {feedback.role} @ {feedback.company_name}
                                 </p>
                              ) : (
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="pt-6 border-t border-primary/10">
                        ...
                        {selectedFeedback.role ? (
                           <p className="text-base  text-blue-600">
                              {selectedFeedback.role} @ {selectedFeedback.company_name}
                           </p>
                        ) : (
