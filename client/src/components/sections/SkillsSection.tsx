...
export function SkillsSection() {
         ...
         <div className="container mx-auto px-6">
            <div className="text-center">
               <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                  <span className="bg-gradient-secondary bg-clip-text text-transparent">My Skills</span>
               </h2>
   ...
   return (
      <section ref={ref} className="py-20 bg-muted/30" data-testid="skills-section">
         <div className="container mx-auto px-6">
            {/* Section Header */}
            <div
            ...
            >
               ...
               <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                  A showcase of my technical expertise and proficiency levels across various technologies and
                  frameworks.
               </p>
            </div>
