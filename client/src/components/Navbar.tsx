   ...
   return (
      <nav
         className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
            isScrolled ? "bg-background/90 backdrop-blur-lg border-b border-border shadow-card" : "bg-transparent"
         }`}
      >
         <div className="container mx-auto px-6 py-4">
            ...
            {/* Chatbot Dialog */}
            <ChatbotDialog isOpen={isChatbotOpen} onClose={() => setIsChatbotOpen(false)} animationType="zoom-spring" />
         </div>
      </nav>
   )
}
