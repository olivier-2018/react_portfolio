...
export interface Database {
   public: {
      Tables: {
         skills: {
            Row: Skill
            Insert: Omit<Partial<Skill>, "id" | "created_at" | "updated_at"> & {
               id?: string
               created_at?: string
               updated_at?: string
            }
         ...
         skill_categories: {
            Row: SkillCategory
            Insert: Omit<Partial<SkillCategory>, "created_at" | "updated_at"> & {
               created_at?: string
               updated_at?: string
            }
         ...
         project_categories: {
            Row: ProjectCategory
            Insert: Omit<Partial<ProjectCategory>, "created_at" | "updated_at"> & {
               created_at?: string
               updated_at?: string
            }
         ...
         customer_feedbacks: {
            ...
            Insert: Omit<Partial<CustomerFeedback>, "id" | "created_at" | "updated_at"> & {
               id?: string
               created_at?: string
               updated_at?: string
            }
...
export type Views<ViewName extends keyof DefaultSchema["Views"]> = DefaultSchema["Views"][ViewName]

export type Functions<FunctionName extends keyof DefaultSchema["Functions"]> = DefaultSchema["Functions"][FunctionName]
